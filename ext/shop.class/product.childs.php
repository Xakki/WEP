...
class product_class extends kernel_extends
{
    ...
    { /*CONFIG*/
        ...
        $this->config['prodItem'] = array( //'text' => 'Полное описание',
        );
    ...
    protected function _create()
    {
        ...
        $thumb2 = array('type' => 'resizecrop', 'w' => '250', 'h' => '250', 'pref' => 's_');
        $maxsz = 3000;
...
// модель
    ...
    public function ParamFieldsForm($id, $rid, $listclause = '')
    { // форма для редак-добавл объявы и поиска объявы
        //$id - id объявы
        //$rid - id рубрики
    ...
    public function fItem($id, $key = 'id')
    { //$id - число либо массив
        $idt = explode(',', $id);
        $arr_stat = $id = array();
