...
class content_class extends kernel_extends
{
	...
	public function setFieldsForm($form = 0)
	{
		...
		$this->fields_form['pg'] = array('type' => 'ckedit', 'caption' => 'Текст',
			...
			'paramedit' => array(
				...
				'extraPlugins' => "'cntlen,syntaxhighlight,timestamp,wordcount,wsc,youtube,spoiler'",
				'toolbar' => 'Page',
			));
		if ($form) {
	...
	public function kPreFields(&$f_data, &$f_param = array(), &$f_fieldsForm = null)
	{
		...
		$this->addForm = array();
		$f_fieldsForm['pagetype']['onchange'] = 'contentIncParam(this,\'' . ADMIN_BH . '\',\'' . (isset($f_data['funcparam']) ? _e($f_data['funcparam']) : '') . '\');';
