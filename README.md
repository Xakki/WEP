...
Установка
-------
1) Скачать фаилы https://github.com/Xakki/WEP/zipball/master <br/>
2) Распаковать на сервере (например /var/www/localhost) <br/>
3) Настройть Apache <br/>
4) Открыть сайт (http://localhost) и вы попадете на страницу дефолтной авторизации (логин root и пароль rootpass) <br/>
...
Если вы уже создали БД вручнуюто не заполняйте поля выделенные цветом
