...
jQuery(function ($)
{
    $.fn.paginator = function (s)
    {
        ...
        function makePagesTableHtml()
        {
            ...
            var next = '<a href="';
            isFunc ? next += 'javascript:void(0)' : next += options.baseUrl + next_page;
            next += '" rel="' + next_page + '">%next%</a>';
            var last = '<a href="';
            isFunc ? last += 'javascript:void(0)' : last += options.baseUrl + (options.pagesTotal);
            last += '" rel="' + options.pagesTotal + '">%last%</a>';
            var prior_page = (parseInt(options.pageCurrent) > 1) ? parseInt(options.pageCurrent) - 1 : 1;
            var prior = '<a href="';
            isFunc ? prior += 'javascript:void(0)' : prior += options.baseUrl + prior_page;
