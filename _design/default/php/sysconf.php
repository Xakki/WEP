...
{
	global $_CFG;
	$html = '<a href="' . $_CFG['PATH']['admin'] . '/login.html?exit=ok"><img src="/_design/default/img/close48.gif" class="exit" alt="CLOSE"/></a><div class="uname">' . $data['user']['name'] . ' [' . $data['user']['gname'] . ']</div>';
